...
def jmove_to_joint_goal(joint_goal):
    robot_group.go(joint_goal, wait=False)
...
if __name__=='__main__':
    ...
    rospy.sleep(2) 
   # move_Joint(1.57,-2.27,1.93,-2.80,-1.57,0) #ready pose 
    move_Joint(1.57,-1.57,1.57,-3.14,-1.57,0) #pick pose 
    go_to_nav_goal(4.5,2,0)
    move_Joint(1.57,-2.27,1.93,-2.80,-1.57,0) #ready pose 
