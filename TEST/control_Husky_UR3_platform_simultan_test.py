...
if __name__=='__main__':
   ...
   # move_Joint(1.57,-2.27,1.93,-1.19,-1.57,0) #home pose
    ...
    while not rospy.is_shutdown():
        ...
        dist_to_go = ar_x/(math.cos(dist_to_rotate/2)) - ar_pose.position.x #0.25: husky base와 ur3 base사이 거리

        ratio_lin_and_ang = dist_to_go/dist_to_rotate
        #dist_ar = 0


        while  dist_to_go-dist_x > 0.05 and abs(dist_to_rotate-dist_th)>0.01 : 
